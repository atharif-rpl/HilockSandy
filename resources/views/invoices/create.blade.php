    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3">
                <div>
                    <h2 class="fw-bold text-primary mb-1">CREATE INVOICE</h2>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <label for="invoice_number" class="form-label fw-medium">
                ...
                <div class="d-flex gap-2">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="bulkActionsDropdown">
                            ...
                            <li><a class="dropdown-item" href="#" id="importFromTemplateBtn">
                                <i class="fas fa-file-import me-2"></i>Import from Template
                            </a></li>
                        </ul>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
                    <div class="text-muted small">
                        ...
                        Make sure all information is correct before saving the invoice.
                    </div>
                    <div class="d-flex gap-2">
                        <button type="button" class="btn btn-outline-secondary" onclick="history.back()">
                            <i class="fas fa-times me-1"></i> Cancel
                        </button>
                        <button type="button" class="btn btn-outline-primary" id="saveDraftBtn2">
                            <i class="fas fa-save me-1"></i> Save as Draft
                        </button>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // Sample templates
        const templates = [
            { name: 'Steel Coil Standard', items: [
                { coil_number: 'SC001', width: 1200, length: 2000, thickness: 2.5, weight: 150, price: 25000 },
                { coil_number: 'SC002', width: 1000, length: 1800, thickness: 2.0, weight: 120, price: 20000 }
            ]},
            { name: 'Aluminum Sheet', items: [
                { coil_number: 'AL001', width: 1500, length: 2500, thickness: 1.5, weight: 80, price: 35000 },
                { coil_number: 'AL002', width: 1200, length: 2000, thickness: 1.2, weight: 65, price: 28000 }
            ]},
            { name: 'Custom Order', items: [
                { coil_number: 'CU001', width: 800, length: 1500, thickness: 3.0, weight: 200, price: 45000 }
            ]}
        ];
        ...
        function addDetailRow(data = {}) {
            ...
            newRow.innerHTML = `
                ...
                <td>
                    <input type="text" name="details[${detailIndex}][coil_number]"
                           class="form-control form-control-sm" value="${data.coil_number || ''}"
                           placeholder="Enter coil number" required>
                </td>
                <td>
                    <input type="number" name="details[${detailIndex}][width]"
                           class="form-control form-control-sm detail-calc" value="${data.width || ''}"
                           step="0.01" min="0" placeholder="Width" required>
                </td>
                <td>
                    <input type="number" name="details[${detailIndex}][length]"
                           class="form-control form-control-sm detail-calc" value="${data.length || ''}"
                           step="0.01" min="0" placeholder="Length" required>
                </td>
                <td>
                    <input type="number" name="details[${detailIndex}][thickness]"
                           class="form-control form-control-sm detail-calc" value="${data.thickness || ''}"
                           step="0.01" min="0" placeholder="Thickness" required>
                </td>
                <td>
                    <input type="number" name="details[${detailIndex}][weight]"
                           class="form-control form-control-sm detail-calc" value="${data.weight || ''}"
                           step="0.01" min="0" placeholder="Weight" required>
                </td>
                <td>
                    <input type="number" name="details[${detailIndex}][price]"
                           class="form-control form-control-sm detail-price" value="${data.price || ''}"
        ...
        document.getElementById('duplicateSelectedBtn').addEventListener('click', function() {
        ...
        document.getElementById('importFromTemplateBtn').addEventListener('click', function() {
            ...
            templates.forEach((template, index) => {
                ...
                item.innerHTML = `
                    ...
                    <p class="mb-1 text-muted">Click to import this template</p>
                `;
                item.addEventListener('click', function() {
                    template.items.forEach(item => addDetailRow(item));
            ...
            const previewHtml = `
                <div class="invoice-preview">
                    <div class="text-center mb-4">
                        <h3>INVOICE</h3>
                        <p class="text-muted">${invoiceNumber}</p>
                    </div>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6 text-end">
                            ...
                            <p><strong>Invoice Date:</strong> ${new Date().toLocaleDateString('id-ID')}</p>
                        </div>
                    </div>
        ...
        function saveDraft() {
            ...
            localStorage.setItem('invoiceDraft_' + Date.now(), JSON.stringify(draftData));
        ...
        @else
            ...
            @foreach(old('details', []) as $key => $detail)
                addDetailRow({
                    coil_number: '{{ $detail['coil_number'] ?? '' }}',
                    width: '{{ $detail['width'] ?? '' }}',
